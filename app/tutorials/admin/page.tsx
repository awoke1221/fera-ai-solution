...
export default function AdminPage() {
  ...
  return (
    <main id="tutorials-admin" className={styles.container}>
      <style>{`
        #tutorials-admin { max-width: 820px; margin: 48px auto; padding: 24px; background: rgba(255,255,255,0.02); border-radius:12px; }
        #tutorials-admin h1 { margin: 0 0 6px 0 }
        #tutorials-admin p { margin: 0 0 12px 0; color: rgba(255,255,255,0.7) }
        #tutorials-admin input, #tutorials-admin textarea { width: 100%; padding: 10px 12px; border-radius:8px; border:1px solid rgba(255,255,255,0.06); background: rgba(0,0,0,0.18); color: var(--text); }
        #tutorials-admin label { display:block; margin-bottom:6px; color: var(--muted); font-weight:600 }
        #tutorials-admin .actions { display:flex; gap:12px; margin-top:8px }
